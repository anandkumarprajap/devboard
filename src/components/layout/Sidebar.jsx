...
export function Sidebar() {
  ...
  return (
    <aside
      className="w-[228px] shrink-0 border-r border-ink-100 dark:border-white/10
    ...
    >
        ...
        <Section label="Coming soon">
          {SOON.map((s) => (
            ...
            >
              ...
              <span
                className="ml-auto text-[9px] uppercase tracking-wider font-medium px-1.5 h-[15px]
      ...
      <div
        className="px-3 py-2.5 border-t border-ink-100 dark:border-white/10
    ...
    >
      {({ isActive }) => (
        <>
          ...
          />
          <span
            className={`flex-1 min-w-0 truncate ${compact ? 'text-[12.5px]' : ''}`}
          >
            {label}
          </span>
          {isActive && (
